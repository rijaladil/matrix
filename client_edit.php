...
<p>&nbsp;</p>
 ...
 <?php 
		 ...
		 $query = "select * from client where idclient ='".mysql_real_escape_string($_GET['id'])."'";
		 $result = mysql_query($query);
		 $matrixclient = mysql_fetch_array($result);
	?>

<form id="formclient" name="formclient" onSubmit="return client()" method="post" action="client_edit_save.php">
  <table width="100%" border="0">
  <tr>
    <td width="1%">&nbsp;</td>
    <td width="19%" align="right">ID CLIENT :</td>
    <td width="80%"><input name="idclient" type="text" id="idclient" value="<?=$matrixclient['idclient'];?>" size="5" /></td>
  </tr>
  <tr>
    <td width="1%">&nbsp;</td>
    <td width="19%" align="right">NAMA CLIENT :</td>
    <td width="80%"><input name="name_client" type="text" id="name_client" value="<?=$matrixclient['name_client'];?>" size="50" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">TLP CLIENT :</td>
    <td><label><input name="no_telp_client" type="text" id="no_telp_client" value="<?=$matrixclient['no_telp_client'];?>" size="20" /></label></td>
  </tr>
   <tr>
    <td>&nbsp;</td>
    <td align="right">EMAIL :</td>
    <td><input name="email_client" type="text" id="email_client" value="<?=$matrixclient['email_client'];?>" size="50" />
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">TGL VISIT :</td>
    <td><input name="tgl_visit" type="text" id="tgl_visit" value="<?=$matrixclient['tgl_visit'];?>" size="20" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">CATEGORY :</td>
    <td><input type="text" name="category"  id="category" value="<?=$matrixclient['id_category'];?>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">MARKETING :</td>
    <td><input type="text" name="marketing" id="marketing" value="<?=$matrixclient['id_marketing'];?>"  /></td>
  </tr>
     <tr>
  	<td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="submit" name="save" id="save" value="UPDATE" />
  </tr>
</table>
</form>
